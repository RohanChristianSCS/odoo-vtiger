...
#             for res in result.get("result", []):
#                 print('-------- vtiger type -----------', vtiger_type, res.get("sostatus"))
#                 print('\n\n----- ressssssssssssssssssss ------------', res)
...
#                         print('\n\n------- last order iddd -----------', order_id)
#                     if (vtiger_type == "SalesOrder" and res.get("sostatus") == "Approved"):
#                         order_id.sudo().action_confirm()
#             return True
#
#     # def sync_vtiger_sales_data(self):
#     #     for company in self:
#     #         for vtiger_type in ["SalesOrder", "Quotes"]:
#     #             print('\n\n------ sync_vtiger_sales_data -------------', vtiger_type)
#     #             company.fetch_so_and_quotes_data(company, vtiger_type=vtiger_type)
#     #     return True
#
#     def sync_vtiger_sale_order(self):
#         for company in self:
#             print('start====================sync_vtiger_sale_order============')
