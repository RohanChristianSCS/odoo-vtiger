...
class ResCompany(models.Model):
    ...
    def sync_vtiger_invoice(self):
        ...
        for company in self:
            print('\n\n=========== for loop calllllllllllllllllllllllllllllllllllllllllllllllllllllllll invoiceeeeeeeee')
            ...
            if result.get('success'):
                ...
                for res in result.get('result', []):
                    ...
                    print('====== res. get line items ======', res.get('lineItems'))
